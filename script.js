const jokes = ["What falls, but never needs a bandage? The rain.",
 "I was going to tell you a joke about boxing but I forgot the punch line.",
  "I'm not a fan of spring cleaning. Let's be honest, I'm not into summer, fall, or winter cleaning either.",
              ...
              "happy multiracial senior women having fun together outdoor   elderly generation people hugging each other at park pinterest",
              "Sabrina Bracher",
...
let ranNum= Math.round((Math.random()*(jokes.length)));
let joke = jokes[ranNum];
const jokeshower = document.getElementById("joke-shower");
console.log(joke);
let showmain = jokeshower.innerHTML =joke;
let addprompt;
const add=()=>{
  addprompt =prompt("Add your Joke Here");
  jokes.push(addprompt);
console.log(jokes[(jokes.length)-1]);
   jokeshower.innerHTML =jokes[(jokes.length)-1]
}
const next =()=>{
  
 ranNum= Math.round((Math.random()*(jokes.length)));
  joke = jokes[ranNum];
 showmain = jokeshower.innerHTML =joke;
}